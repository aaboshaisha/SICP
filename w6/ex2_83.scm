...
; modified apply generic to handle coercion 
...
(define (install-rational-package)
  ...
  (put '=zero? '(rational) (lambda (r) (equ-zero r)))
  (put 'raise '(rational) (lambda (r) (* 1.0 (/ (numer r) (denom r)))))
